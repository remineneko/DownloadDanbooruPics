...
def manual_download():
    ...
    DownloadMultipleTags(user_input_list, "prefered\\download\\location").initiate_download()
...
def auto_download():
    ...
    DownloadMultipleTags(list_of_tags,"prefered\\download\\location").initiate_download()
